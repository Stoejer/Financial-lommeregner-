...
public class InputOutputTool {
    ...
    public void menu() {
        ...
        /* ovenover er der kodet nogle tal til vores inputs så brugeren kan taste f.eks. 1 og så regne fremtidsværdi */
    }
    ...
    public void annuitetsopsparingChosen() {
        ...
        menu();
        /* ovenover ser vi koderne deres bruges til de forskellige inputs */
    }
...
/** dette data bliver brugt til at lave en velkommes besked til brugeren af programmet */ 
    String menuString = "\n\n"
    ...
    /** her anvendes der string da det er en sekvens af tegn*/
}
